...
*/@GetMapping("/getProductNameByPrductId/{id}")
	public String getProductNameByPrductId(@PathVariable(name = "id") int pid){
		return productService.getProductNameByPrductId(pid);
	}
}
